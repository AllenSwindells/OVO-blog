...
function theme_menu_item_start_13_45($class, $title, $attrs, $link_class, $item_type = '') {
    ...
    ob_start();
    ?><li class=" bd-menuitem-45 bd-toplevel-item <?php echo $class; ?>">
...
?>
    ...
    <?php if ($item_type === 'mega'): ?>
        <div class="bd-menu-18 bd-no-margins  bd-mega-grid bd-grid-13  <?php echo $class; ?>">
            <div class="container-fluid">
                <div class="separated-grid row">
    <?php else: ?>
        <ul class="bd-menu-18 bd-no-margins  <?php echo $class; ?>">
    <?php endif; ?>
<?php
    return ob_get_clean();
}
...
function theme_submenu_item_start_13_46($class, $title, $attrs, $link_class, $item_type = '') {
    ...
    switch($item_type) {
        case 'category':
            ...
            break;
        case 'subcategory':
            $class .= ' bd-mega-item  bd-menuitem-48';
            break;
    }
    ob_start();
?>
    ...
    <?php if ($item_type === 'category'): ?>
        <div class=" bd-menuitem-46 <?php echo $class; ?>">
            <div class=" bd-griditem-9 bd-grid-item">
    <?php else: ?>
        <li class=" bd-menuitem-46 <?php echo $class; ?>">
    <?php endif; ?>
