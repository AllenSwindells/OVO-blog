...
<div class="data-control-id-1979 bd-comments-4" id="comments">
	...
	<?php if (post_password_required()) { ?>
		<div class="data-control-id-1938 bd-container-24 bd-tagstyles bd-custom-blockquotes nocomments">
		<h2><?php _e('This post is password protected. Enter the password to view any comments.', 'default') ?></h2>
		</div><?php
	} else {
		if (have_comments()) { ?>
			<div class="data-control-id-1938 bd-container-24 bd-tagstyles bd-custom-blockquotes comments">
				<h2><?php printf(
    ...
    echo str_replace(
        ...
        array(
            ...
            '<div  class="data-control-id-1972 bd-container-25 bd-tagstyles bd-custom-blockquotes"><h2',
            '</h2></div>',
