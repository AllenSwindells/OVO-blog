...
?>
                ...
                <div class="separated-item-28 col-md-4 col-sm-6 ">
                    ...
                    <div class="bd-griditem-28">
                        <article id="<?php echo $id; ?>" class=" bd-article-6 clearfix <?php echo $class; if (theme_is_preview()) echo ' bd-post-id-' . theme_get_the_ID(); ?>">
    <?php echo theme_get_post_thumbnail(array(
    'size' => 'large',
    'class' => ' bd-postimage-9 bd-imagescaling bd-imagescaling-7',
    ...
    <div class="bd-container-inner">
        <div class=" bd-posticonauthor-48 bd-no-margins">
...
?>
<h2 class=" bd-postheader-18 bd-no-margins">
    <?php echo $title; ?>
</h2>
<?php
    }
...
?>
    ...
    <a class="bd-postreadmore-8 bd-no-margins bd-button-25 "   title="<?php echo strip_tags('More...') ?>" href="<?php echo get_permalink($post->ID) ?>"><?php _e('More...', 'default'); ?></a>
<?php endif; ?>
</article>
                        <?php
                        global $withcomments;
