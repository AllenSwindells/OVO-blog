...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div class=" bd-comment-6 <?php echo $comment->comment_type ?>">
 ...
 col-md-2">
    <div class="bd-layoutcolumn-27 bd-no-margins bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-commentavatar-6">
 ...
 col-md-11">
    <div class="bd-layoutcolumn-24 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-commentmetadata-6 comment-meta commentmetadata">
    ...
    <div>
		...
		<div class=" bd-commenttext-6 comment-body">
...
?>
<div class=" bd-commentreply-6 reply">
<?php
...
<div class=" bd-comments-6" id="comments">
	...
	<?php if (post_password_required()) { ?>
		<div class=" bd-container-85 bd-tagstyles bd-custom-blockquotes nocomments">
		<h2><?php _e('This post is password protected. Enter the password to view any comments.', 'default') ?></h2>
		</div><?php
	} else {
		if (have_comments()) { ?>
			<div class=" bd-container-85 bd-tagstyles bd-custom-blockquotes comments">
				<h2><?php printf(
    ...
    echo str_replace(
        ...
        array(
            ...
            ' class="comment-respond  bd-commentsform-6',
            '<div  class=" bd-container-86 bd-tagstyles bd-custom-blockquotes"><h2',
            '</h2></div>',
