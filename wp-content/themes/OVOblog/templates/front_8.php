...
<body <?php body_class(' bootstrap bd-body-8 
...
?>
    ...
    <span class="bd-icon"></span><span></span>
        ...
        <a target="_blank" class=" bd-socialicon-22 bd-socialicon" href="//instagram.com/ovonetwork">
    <span class="bd-icon"></span><span></span>
</a>
...
<div class=" bd-stretchtobottom-8 bd-stretch-to-bottom" data-control-selector=".bd-contentlayout-12">
...
?>
    ...
    <div class="bd-container-inner">
        <a class="bd-iconlink-2 bd-own-margins bd-iconlink " href="https://www.instagram.com/ovonetwork">
