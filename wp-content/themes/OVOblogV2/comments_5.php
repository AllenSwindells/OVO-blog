...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
 ...
 col-md-2">
    <div class="bd-layoutcolumn-55 bd-no-margins bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-commentavatar-5">
...
<div class=" bd-comments-5" id="comments">
	...
	<?php if (post_password_required()) { ?>
		<div class=" bd-container-27 bd-tagstyles bd-custom-blockquotes nocomments">
		<h2><?php _e('This post is password protected. Enter the password to view any comments.', 'default') ?></h2>
		</div><?php
	} else {
		if (have_comments()) { ?>
			<div class=" bd-container-27 bd-tagstyles bd-custom-blockquotes comments">
				<h2><?php printf(
    ...
    echo str_replace(
        ...
        array(
            ...
            '<div  class=" bd-container-28 bd-tagstyles bd-custom-blockquotes"><h2',
            '</h2></div>',
