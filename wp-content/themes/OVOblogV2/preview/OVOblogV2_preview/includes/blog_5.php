...
?>
    ...
    'size' => 'large',
    'class' => 'data-control-id-1474122 bd-postimage-9 bd-imagescaling bd-imagescaling-7',
    'img_class' => 'data-control-id-1474109 bd-imagestyles',
    'attributes' => '',
    'img_attributes' => '',
)); ?>
	
		<div class="data-control-id-1485100 bd-spacer-3 clearfix"></div>
	
		<div class="data-control-id-1025897 bd-layoutbox-14 bd-no-margins bd-no-margins clearfix">
    <div class="bd-container-inner">
        <div class="data-control-id-1476316 bd-posticonauthor-48 bd-no-margins">
    <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')) ?>" title="<?php echo esc_attr(__('View all posts by ' . get_the_author(), 'default')) ?>">
        <span class="data-control-id-1476315 "><span><?php echo get_the_author(); ?></span></span>
    </a>
</div>
	
		<div class="data-control-id-1995 bd-posticondate-12">
    <span class="data-control-id-1994 "><span><?php echo get_the_date(); ?></span></span>
</div>
    </div>
</div>
...
?>
<h2 class="data-control-id-1475441 bd-postheader-18 bd-no-margins">
    <?php echo $title; ?>
</h2>
<?php
    }
...
?>
		...
		<div class="data-control-id-1485135 bd-spacer-8 clearfix"></div>
	
		<?php if ($post && !is_singular() && !theme_is_empty_html('More...')): ?>
    <a class="bd-postreadmore-8 bd-no-margins bd-button-25 data-control-id-1475431"   title="<?php echo strip_tags('More...') ?>" href="<?php echo get_permalink($post->ID) ?>"><?php _e('More...', 'default'); ?></a>
<?php endif; ?>
</article>
                        <?php
                        global $withcomments;
...
<?php
    ...
    if ( $wp_query->max_num_pages > 1 ) {
        echo preg_replace(
            ...
            array(
                '<li  class="data-control-id-2150 bd-paginationitem-1 active"$1',
                '<ul  class="data-control-id-2151 bd-pagination pagination"',
                '<li  class="data-control-id-2150 bd-paginationitem-1">'
            ),
