...
function theme_vmenu_block($title = '', $content = '', $class = '', $id = '') {
    ...
    <div class="data-control-id-3501 bd-vmenu-1" data-responsive-menu="true" data-responsive-levels="">
...
class VMenuWidget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        ?>
        <div class="data-control-id-3499 bd-blockcontent bd-tagstyles bd-custom-bulletlist shape-only">
