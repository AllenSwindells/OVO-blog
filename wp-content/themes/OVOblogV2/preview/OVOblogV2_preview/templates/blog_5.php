<?php $GLOBALS['theme_current_template_info'] = array('name' => 'blogTemplate'); ?>
...
<body <?php body_class('data-control-id-55 bootstrap bd-body-5  bd-pagebackground bd-margins'); /*   */ ?>>
...
?>
    ...
    <span class="bd-icon"></span><span></span>
		...
		<div class="data-control-id-1243572 bd-stretchtobottom-3 bd-stretch-to-bottom" data-control-selector=".bd-contentlayout-5">
<div class="bd-contentlayout-5 bd-page-width   bd-sheetstyles data-control-id-1147716 bd-no-margins bd-margins" >
    <div class="bd-container-inner">
        ...
        <div class="bd-flex-vertical bd-stretch-inner bd-no-margins">
            ...
            <div class="bd-flex-horizontal bd-flex-wide bd-no-margins">
                ...
                <div class="bd-flex-vertical bd-flex-wide bd-no-margins">
                    ...
                    <div class="data-control-id-1147714 bd-layoutitemsbox-1 bd-flex-wide bd-margins">
    <div class="data-control-id-1563936 bd-content-1">
