<?php $GLOBALS['theme_current_template_info'] = array('name' => 'blog-header'); ?>
...
<body <?php body_class('data-control-id-1511720 bootstrap bd-body-4  bd-pagebackground bd-margins'); /*   */ ?>>
...
?>
    ...
    <span class="bd-icon"></span><span></span>
        ...
        <a target="_blank" class="data-control-id-1598132 bd-socialicon-19 bd-socialicon" href="//plus.google.com/share?url=">
    <span class="bd-icon"></span><span></span>
</a>
    ...
    <span class="bd-icon"></span><span></span>
        ...
        <a target="_blank" class="data-control-id-1598141 bd-socialicon-22 bd-socialicon" href="//instagram.com/">
    <span class="bd-icon"></span><span></span>
</a>
		...
		<div class="data-control-id-1511757 bd-stretchtobottom-7 bd-stretch-to-bottom" data-control-selector=".bd-contentlayout-11">
<div class="bd-contentlayout-11 bd-page-width   bd-sheetstyles data-control-id-1511751 bd-no-margins bd-margins" >
    <div class="bd-container-inner">
        ...
        <div class="bd-flex-vertical bd-stretch-inner bd-no-margins">
            ...
            <div class="bd-flex-horizontal bd-flex-wide bd-no-margins">
                ...
                <div class="bd-flex-vertical bd-flex-wide bd-no-margins">
                    ...
                    <div class="data-control-id-1511749 bd-layoutitemsbox-4 bd-flex-wide bd-margins">
...
?>
    ...
    <div class="bd-container-inner">
        <span class="bd-iconlink-2 bd-own-margins bd-icon-29 bd-icon data-control-id-1566547"></span>
	
		<span class="bd-iconlink-5 bd-own-margins bd-icon-38 bd-icon data-control-id-1566572"></span>
	
		<span class="bd-iconlink-9 bd-own-margins bd-icon-48 bd-icon data-control-id-1566606"></span>
...
?>
    ...
    <?php endif; ?>
		...
		<div data-smooth-scroll data-animation-time="250" class="data-control-id-1511747 bd-smoothscroll-1"><a href="#" class="data-control-id-1511737 bd-backtotop-2 ">
    <span class="bd-icon-7 bd-icon data-control-id-1511736"></span>
</a></div>
<div id="wp-footer">
    <?php wp_footer(); ?>
