...
<?php
    if (have_posts()) { ?>
        <div class="data-control-id-1090 bd-grid-4 bd-margins">
...
?>
		...
		<div class="data-control-id-1024989 bd-layoutbox-2 bd-no-margins clearfix">
    <div class="bd-container-inner">
        <div class="data-control-id-1017 bd-posticondate-2 bd-no-margins">
    <span class="data-control-id-1016 bd-icon bd-icon-34"><span><?php echo get_the_date(); ?></span></span>
</div>
	
		<div class="data-control-id-1026 bd-posticonauthor-3 bd-no-margins">
    <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')) ?>" title="<?php echo esc_attr(__('View all posts by ' . get_the_author(), 'default')) ?>">
		...
		<div class="data-control-id-1025097 bd-layoutbox-4 bd-no-margins clearfix">
    <div class="bd-container-inner">
        <?php echo theme_get_post_thumbnail(array(
    
    'class' => 'data-control-id-1009 bd-postimage-2 bd-no-margins',
...
?>
<div class="data-control-id-234738 bd-postcontent-8 bd-tagstyles bd-contentlayout-offset" <?php echo $editor_attrs; ?>>
...
<?php endif; ?>
		...
		<div class="data-control-id-1025231 bd-layoutbox-6 bd-no-margins clearfix">
    <div class="bd-container-inner">
        <div class="data-control-id-1001968 bd-posticontags-18 bd-no-margins">
