...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div class=" bd-comment-7 <?php echo $comment->comment_type ?>">
 ...
 col-md-2">
    <div class="bd-layoutcolumn-19 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-commentavatar-7">
 ...
 col-md-22">
    <div class="bd-layoutcolumn-9 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-commentmetadata-7 comment-meta commentmetadata">
    ...
    <div>
		...
		<div class=" bd-commenttext-7 comment-body">
...
?>
<div class=" bd-commentreply-7 reply">
<?php
...
<div class=" bd-comments-7" id="comments">
	...
	<?php if (post_password_required()) { ?>
		<div class=" bd-container-61 bd-tagstyles bd-custom-blockquotes nocomments">
		<h2><?php _e('This post is password protected. Enter the password to view any comments.', 'default') ?></h2>
		</div><?php
	} else {
		if (have_comments()) { ?>
			<div class=" bd-container-61 bd-tagstyles bd-custom-blockquotes comments">
				<h2><?php printf(
    ...
    echo str_replace(
        ...
        array(
            ...
            ' class="comment-respond  bd-commentsform-7',
            '<div  class=" bd-container-65 bd-tagstyles bd-custom-blockquotes"><h2',
            '</h2></div>',
