...
?>
 ...
 col-lg-4
 col-sm-6">
    <div class="bd-layoutcolumn-25 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-layoutbox-16 bd-no-margins clearfix">
    <div class="bd-container-inner">
        <?php
...
?>
    ...
    <span class=" bd-icon bd-icon-39"><span><?php echo get_the_date(); ?></span></span>
</div>
    ...
    <?php edit_post_link('<span class=" bd-icon bd-icon-43"><span>'.__('Edit', 'default').'</span></span>', ''); ?>
    <?php endif; ?>
</div>
    </div>
</div></div></div>
...
?>
<div class=" bd-postcontent-2 bd-tagstyles  bd-contentlayout-offset" <?php echo $editor_attrs; ?>>
    ...
    <span class=" bd-icon bd-icon-44"><span><?php echo get_the_category_list(', ');?></span></span>
    <?php endif ?>
</div>
    </div>
</div>
