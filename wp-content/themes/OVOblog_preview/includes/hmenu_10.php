...
?>
    ...
    <nav class="data-control-id-1597535 bd-hmenu-10" data-responsive-menu="true" data-responsive-levels="">
        
            <div class="data-control-id-1597534 bd-responsivemenu-14 collapse-button">
    <div class="bd-container-inner">
        <div class="bd-menuitem-64 data-control-id-1597540">
        ...
        <div class="data-control-id-1597533 bd-horizontalmenu-12 clearfix">
            <div class="bd-container-inner">
            <?php
...
function theme_menu_10_25($content = '') {
    ob_start();
    ?><ul class="data-control-id-1597585 bd-menu-25 nav nav-pills navbar-left">
    <?php echo $content; ?>
</ul><?php
    return ob_get_clean();
}
...
function theme_menu_item_start_10_60($class, $title, $attrs, $link_class, $item_type = '') {
    ...
    ob_start();
    ?><li class="data-control-id-1597586 bd-menuitem-60 bd-toplevel-item <?php echo $class; ?>">
...
?>
    ...
    <?php if ($item_type === 'mega'): ?>
        <div class="bd-menu-26 data-control-id-1597597 bd-mega-grid bd-grid-16 data-control-id-1597561 <?php echo $class; ?>">
            <div class="container-fluid">
                <div class="separated-grid row">
    <?php else: ?>
        <ul class="bd-menu-26 data-control-id-1597597 <?php echo $class; ?>">
    <?php endif; ?>
<?php
    return ob_get_clean();
}
...
function theme_submenu_item_start_10_61($class, $title, $attrs, $link_class, $item_type = '') {
    ...
    switch($item_type) {
        case 'category':
            $class .= ' bd-mega-item data-control-id-1597551 bd-menuitem-62';
            $class .= ' separated-item-10';
            break;
        case 'subcategory':
            $class .= ' bd-mega-item data-control-id-1597575 bd-menuitem-63';
            break;
    }
    ob_start();
?>
    ...
    <?php if ($item_type === 'category'): ?>
        <div class="data-control-id-1597598 bd-menuitem-61 <?php echo $class; ?>">
            <div class="data-control-id-1597563 bd-griditem-10 bd-grid-item">
    <?php else: ?>
        <li class="data-control-id-1597598 bd-menuitem-61 <?php echo $class; ?>">
    <?php endif; ?>
