...
Hero one
*/
$GLOBALS['theme_current_template_info'] = array('name' => 'hero-one');
?>
...
<body <?php body_class('data-control-id-1465885 bootstrap bd-body-3  bd-pagebackground bd-margins'); /*   */ ?>>
...
?>
    ...
    <span class="bd-icon"></span><span></span>
		...
		<div class="bd-contentlayout-10 bd-sheetstyles data-control-id-1465892 bd-no-margins bd-margins" >
    <div class="bd-container-inner">
        ...
        <div class="bd-flex-vertical bd-stretch-inner bd-no-margins">
            ...
            <div class="bd-flex-horizontal bd-flex-wide bd-no-margins">
                ...
                <div class="bd-flex-vertical bd-flex-wide bd-no-margins">
                    ...
                    <div class="data-control-id-1465890 bd-layoutitemsbox-3 bd-flex-wide bd-margins">
    <div class="data-control-id-1465894 bd-content-2">
