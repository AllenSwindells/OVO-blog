...
?>
                ...
                <div class="separated-item-25 col-md-6 col-sm-6 ">
                    ...
                    <div class="bd-griditem-25">
                        <article id="<?php echo $id; ?>" class=" bd-article-5 clearfix <?php echo $class; if (theme_is_preview()) echo ' bd-post-id-' . theme_get_the_ID(); ?>">
    <?php echo theme_get_post_thumbnail(array(
    
    'class' => ' bd-postimage-5',
...
?>
    ...
    <div class="bd-container-inner">
        <div class=" bd-posticonauthor-21 bd-no-margins">
...
?>
<div class=" bd-postcontent-5 bd-tagstyles bd-custom-blockquotes bd-contentlayout-offset" <?php echo $editor_attrs; ?>>
