<?php $GLOBALS['theme_current_template_info'] = array('name' => 'pageTemplate'); ?>
...
<body <?php body_class('data-control-id-31 bootstrap bd-body-7  bd-pagebackground bd-margins'); /*   */ ?>>
...
<div class="bd-contentlayout-7 bd-page-width   bd-sheetstyles data-control-id-378 bd-no-margins bd-margins" >
    <div class="bd-container-inner">
 ...
 <?php theme_sidebar_area_6(); ?>
            <div class="bd-flex-horizontal bd-flex-wide bd-no-margins">
                ...
                <div class="bd-flex-vertical bd-flex-wide bd-no-margins">
                    ...
                    <div class="data-control-id-1118957 bd-layoutitemsbox-21 bd-flex-wide bd-margins">
