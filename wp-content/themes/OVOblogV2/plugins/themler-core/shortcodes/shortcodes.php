...
function themler_init_filters() {
    ...
    add_filter('the_content', 'themler_column_filter', 0);
    add_filter('theme_the_content', 'themler_column_filter', 0);
    add_filter('widget_text', 'themler_column_filter', 0);
    add_filter('themler_column_filter', 'themler_column_filter', 0);

    add_filter('the_content', 'themler_old_row_filter', 0);
    add_filter('theme_the_content', 'themler_old_row_filter', 0);
    add_filter('widget_text', 'themler_old_row_filter', 0);
    add_filter('themler_column_filter', 'themler_old_row_filter', 0);
...
function themler_shortcodes_anchor($atts) {
    ...
    return '<div class="bd-anchor" id="' . ShortcodesUtility::escape($name) . '"></div>';
}
...
function themler_shortcode_advertisement($atts) {
    ...
    $ad = get_option('theme_ad_code_' . $code);
    if (!empty($ad)):
        $ad = '<div class="ad align' . ShortcodesUtility::escape($align) . '">' . $ad . '</div>';
        if (!$inline)
