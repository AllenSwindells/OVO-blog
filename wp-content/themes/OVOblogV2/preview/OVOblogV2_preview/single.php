<?php $GLOBALS['theme_current_template_info'] = array('name' => 'singlePostTemplate'); ?>
...
<body <?php body_class('data-control-id-61 bootstrap bd-body-6  bd-pagebackground-198 bd-margins'); /*   */ ?>>
...
?>
    ...
    <span class="bd-icon"></span><span></span>
		...
		<div class="data-control-id-1243589 bd-stretchtobottom-4 bd-stretch-to-bottom" data-control-selector=".bd-contentlayout-6">
<div class="bd-contentlayout-6  bd-sheetstyles-2 data-control-id-366 bd-no-margins bd-margins" >
    <div class="bd-container-inner">
 ...
 <?php theme_sidebar_area_6(); ?>
            <div class="bd-flex-horizontal bd-flex-wide bd-no-margins">
                ...
                <div class="bd-flex-vertical bd-flex-wide bd-no-margins">
                    ...
                    <div class="data-control-id-1118950 bd-layoutitemsbox-20 bd-flex-wide bd-no-margins">
