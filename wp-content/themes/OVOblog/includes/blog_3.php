...
?>
                ...
                <div class="separated-item-21 col-md-12 ">
                    ...
                    <div class="bd-griditem-21">
                        <div class="bd-containereffect-45 container-effect container "><article id="<?php echo $id; ?>" class=" bd-article-4  clearfix <?php echo $class; if (theme_is_preview()) echo ' bd-post-id-' . theme_get_the_ID(); ?>">
...
?>
<div class=" bd-postcontent-3 bd-tagstyles  bd-contentlayout-offset" <?php echo $editor_attrs; ?>>
