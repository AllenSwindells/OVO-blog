...
?>
    ...
    theme_print_sidebar_content($current_sidebar_content, 'secondary', 'data-control-id-1519950 bd-secondarywidgetarea-10 clearfix', '');
?>
        ...
        <?php if (theme_is_preview()): ?>
            ...
            <aside class="bd-sidebararea-1-column data-control-id-1519948 bd-flex-vertical bd-flex-fixed <?php if ($hide) echo ' hidden bd-hidden-sidebar'; ?>">
        ...
        <?php else: ?>
            <?php if ($area_content): ?>
                <aside class="bd-sidebararea-1-column data-control-id-1519948 bd-flex-vertical bd-flex-fixed">
                    <div class="bd-sidebararea-1 bd-flex-wide  bd-margins">
