<?php theme_add_template_option('Blog', 'blog-header', __('Blog%20Header', 'default')); ?>
<?php theme_add_template_query_option('Blog', 'blog-header', __('Blog%20Header', 'default')); ?>
...
<?php theme_add_template_option('Home', 'search', __('Search', 'default')); ?>
